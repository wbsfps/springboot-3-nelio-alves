...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        var order1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), user1);
        var order2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), user2);
        var order3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), user1);
